...
`python blackbox_pure_gnn_agent.py --episodes 100000 --wandb --wandb_project <your project> --wandb_entity <your entity> --checkpoint_interval 10000 --eval_episodes 100 --port 9010 --eval_interval 1000 --eval_temperature 0.001 --train_temperature_start 1.0 --curiosity_anneal_frac 0.1 --entropy_beta 0.1 --entropy_min 0.005 --train_temperature_anneal_frac 0.7 --train_temperature_end 0.001`
