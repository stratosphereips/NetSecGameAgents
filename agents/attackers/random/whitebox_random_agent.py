...
import random
from netsecgame import Action, Observation, AgentRole
...
class RandomWhiteboxAttackerAgent(ActionListAgent):
    ...
    def select_action(self, observation:Observation)->Action:
        ...
        # Randomly choose one of the valid actions using seeded rng
...
def main():
    ...
    # Create agent
    agent = RandomWhiteboxAttackerAgent(args.host, args.port, AgentRole.Attacker, seed=args.seed)

    # Mlflow experiment name        
    experiment_name = "Random Whitebox Attacker Agent"
    if args.mlflow_url:
