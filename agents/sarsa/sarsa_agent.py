...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=os.path.join(args.logdir, "sarsa_agent.log"), filemode='w', format='%(asctime)s %(name)s %(levelname)s %(message)s', datefmt='%H:%M:%S',level=logging.INFO)
