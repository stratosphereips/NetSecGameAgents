...
Q5 = """Provide the best next {{action_str}} action in the correct JSON format if it is valid based on the provided rules.
...
if __name__ == "__main__":
    ...
    experiment_description = "LLM RAG agent. " + f"Model: {args.llm}"
    ...
    for episode in range(1, args.test_episodes + 1):
        ...
        for i in range(num_iterations):
            ...
            # state_embedding = sentence_transformer_ef(str(observation.state.as_json()))
    ...
    # mlflow.log_artifact("states_prompts_responses.csv")
